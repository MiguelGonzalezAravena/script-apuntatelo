...
if ($rango=="Moderador" or $rango=="Administrador")
{
	...
	<br><br><br>
	&nbsp;Ir a panel <a href="usuarios.php">Usuarios</a> - (S�lo admins)<br><br><br>
	&nbsp;Ir a panel <a href="">Informaci�n Moderadores</a><br><br><br>
	&nbsp;Ir a panel <a href="stickies.php">Stickies</a> - (S�lo admins)<br><br><br>
