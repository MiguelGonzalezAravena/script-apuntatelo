...
if ($action=="error4")
echo "Operaci&oacute;n no v�lida. Revis� no haber dejado alguno de los campos vac�os.";
?>
</font>
<?
...
<td>
	<div class="esq1" style="float:left;"></div>
	<div class="franja" style="float:left; width: 884px;"><div style="padding-top:2px;">Historial de suspensi�n <?if ($tipo=="usuario") echo "de ".$a; if($tipo=="moderador") echo "realizado por ".$a;?></div></div>
	<div class="esq2" style="float:left;"></div>
</td>
</tr>
<tr>
...
<td width="160">
<font size="2" color="black"><b>Fecha supensi�n:</b></font>
</td>
<td width="125">
<font size="2" color="black"><b>Moderador</b></font>
</td>
<td width="160">
<font size="2" color="black"><b>Fecha reactivaci�n</b></font>
</td>
</tr>
<?
if ($tipo=="ultimos")
