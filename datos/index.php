...
?>
    <div class="bordes">
      <br />
      <div align="center">MIS DATOS</div><br />
...
<?php
    ...
    if ($var2 == 1) {
      if ($nombre != '' && $pais != '' && $ciudad != '' && $sexo != '' && $dia != '' && $mes != '' && $ano != 0) {
        $sql = "
          UPDATE usuarios 
        ...
        alert('Existen campos vac&iacute;os');
      }
    }
  } else {
    redirect($url);
