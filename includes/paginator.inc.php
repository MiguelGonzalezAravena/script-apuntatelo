...
if (!isset($_pagi_conteo_alternativo)) {
  ...
  // Se realiza el conteo desde MySQL con COUNT(*)
...
} else if (!is_array($_pagi_propagar)) {
...
if ($_pagi_actual != 1) {
  ...
  $_pagi_navegacion_temporal[] = "<a ".$_pagi_nav_estilo_mod." href='".$_pagi_enlace."_pagi_pg=".$_pagi_url."'><font color='gray'>$_pagi_nav_anterior</font></a>";
}
...
if ($_pagi_actual < $_pagi_totalPags) {
  ...
  $_pagi_url = $_pagi_actual + 1; // Será el número de página al que enlazamos
  $_pagi_navegacion_temporal[] = "<a " . $_pagi_nav_estilo_mod . " href='" . $_pagi_enlace . "_pagi_pg=" . $_pagi_url . "'><font color='gray'>" . $_pagi_nav_siguiente . "</font></a>";
}
...
// Si ocurrió error y mostrar errores esté activado
 ...
 */
 ...
 // N�mero del último registro de la página actual
