...
class pfcInfo {
  ...
  function pfcInfo($serverid, $data_private_path = '') {
    ...
    // Add options for fix _GetCacheFile
    $params = array();
    $params['serverid'] = $serverid;
    $params['data_private_path'] = $data_private_path;
    $this->globalConfig = new pfcGlobalConfig($params);

    $cachefile = $this->globalConfig->_GetCacheFile($serverid, $data_private_path);
    ...
    // $params['serverid']          = $serverid;
    // $params['data_private_path'] = $data_private_path;
    $this->c = $this->globalConfig->Instance($params);
  }
  
  function free() {
    // free the pfcglobalconfig instance
    $this->globalConfig->Instance(array(), true);
  }
