...
$cuerpo = isset($_POST['cuerpo']) ? no_injection($_POST['cuerpo']) : '';
...
if ($coments != 0 && $coments != 1) {
  $coments = 0;
}


if ($privado != 0 && $privado != 1) {
  $privado = 0;
}
...
<?php
// TO-DO: ¿Es necesario hacer esta consulta?
$sql = "
...
<?php
// TO-DO: ¿Será necesario hacer esto?
/*
