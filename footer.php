...
<table cellpadding="0" cellspacing="0" width="980" border="0" align="center" style="padding-bottom: 0px; font-size:10px; background-color: #FFFFFF;">
  ...
  <tr>
    <td align="center" style="background-color: #EDEDED;">
      <div style="height: 20px; width: 980px;">
        ...
        <div style="height: 20px; width: 958px; float: left; background-color: #D2D3D4; padding-top: 5px;"><?php echo $name; ?> v3.0 - Copyright &copy; 2008 - <?php echo date('Y'); ?> - Todos los derechos reservados</div>
  ...
  <tr>
    <td align="center" style="background-color: #EDEDED;">
      <div style="height: 7px; width: 980px;">
        <div style="height: 7px; width: 11px; float: left;"></div>
        <div style="height: 7px; width: 958px; float: left; font-size: 1px;">&nbsp;</div>
        <div style="height: 7px; width: 11px; float: left;"></div>
  ...
  <tr>
    <td align="center">
      <div style="height: 8px; width: 980px;">
        <div class="esquina_inf_izq"></div>
        <div style="height: 8px; width: 958px; float: left; font-size: 1px; background-color: #EDEDED;">&nbsp;</div>
