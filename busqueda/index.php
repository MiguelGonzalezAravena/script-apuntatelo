...
<table cellpadding="0" cellspacing="0" width="487" align="center" border="0">
	...
	<td align="center" valign="middle">
		...
		<tr>
		<td valign="top">
			<div class="size11">Buscar:</div> <input type="text" name="palabra" size="30" MAXLENGTH="200" value="<?php echo $palabra; ?>">
		</td>
		<td valign="top">
			<div class="size11">Usuario:</div> <input type="text" name="usuario" size="20" MAXLENGTH="200" value="<?php echo $usuario; ?>"><br><br>
		</td>
		</tr>
		<tr>
		<td>
...
?>
	...
	<div class="size12">Debe especificar la b&uacute;squeda</div>
	</td>
...
?>
			...
			&nbsp;<img src="<?php echo $images; ?>/iconos/<?php echo $row['imagen'];?>" border="0"><?php if ($privado == 1) { ?>&nbsp;<img src="<?php echo $images; ?>/iconos/candado.gif" border="0"><?php } ?>&nbsp;<a href="/posts/<?php echo$row['id']; ?>/<?php echo $row['link_categoria']; ?>/<?php echo corregir($row['titulo']).".html"; ?>"><font size="2" color="black"><?php echo $titulo2; if ($tit==1) echo"...";?></font></a>
			</td>
