...
?>
            ...
            <tr> 
              ...
              <td>
                <div class="size11" style="font-weight: bold;">
                  <input type="checkbox" name="privado" value="privado"<?php echo ($privado == 1 ? ' checked="checked"' : ''); ?> />
                  Privado
                </div>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <div class="size11" style="font-weight: bold;">
                  <input type="checkbox" name="coments" value="coments"<?php echo ($coments == 1 ? ' checked="checked"' : ''); ?> />
