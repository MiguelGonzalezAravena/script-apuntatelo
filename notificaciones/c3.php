        ...
        <table cellpadding="0" cellspacing="0" width="387" align="center" border="0">
          <tr>
            ...
            <td> 
              ...
              <div class="franja" style="float: left; width: 371px;"><div style="padding-top: 2px;">Felicitaciones</div></div>
              <div class="esq2" style="float: left;"></div>
            </td>
          </tr>
        </table>
        <br />
        <div align="center"><font size="2">El usuario ha sido activado, ya puedes iniciar sesi&oacute;n y utilizar las utilidades de un usuario registrado.</font></div> 
      </td>
      <td width="35%" height="30%" align="center"></td>
    </tr>
    <tr>
