      ...
      <td width="30%" height="35%" align="left" valign="top" class="fondo_cuadro">
        <table cellpadding="0" cellspacing="0" width="387" align="center" border="0">
          <tr>
            ...
            <td> 
              ...
              <div class="franja" style="float: left; width: 371px;"><div style="padding-top: 2px;">Atenci&oacute;n</div></div>
        ...
        <div align="center">
          <font size="2">
            ...
            Si el correo no lleg&oacute;, av&iacute;sanos escribiendo a <a href="mailto:<?php echo $email; ?>"><?php echo $email; ?></a> con tu nick de asunto.
          </font>
        </div>
      </td>
      <td width="35%" height="30%" align="center"></td>
