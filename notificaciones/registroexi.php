  ...
  <table width="100%" height="365" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td width="30%" height="35%" align="left" valign="top" class="fondo_cuadro">
        ...
        <br /><br />
        <div align="center"><font size="2">Tu usuario ya ha sido activado. A partir de ahora, podr&aacute;s iniciar sesi&oacute;n y acceder a todas las secciones de la p&aacute;gina. &iexcl;Bienvenido!</font></div> 
      </td>
      <td width="35%" height="30%" align="center"></td>
    </tr>
    <tr>
